...
{
    // To prevent an  in safe mode, we supply a @, no other way i think
    @set_time_limit(0);
    ...
    if (!$core_backend->bindDomain(XARMLS_DNTYPE_CORE, 'xarigami')) {
        ...
        return xarTplModule('translations','user', 'errors', array('type' => 'missing_core_skels', 'link' => $link, 'modname' => $modname));
    }
